    ...
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12 tar">
                <button type="button" class="btn btn-sm btn-outline-primary mb10" onclick="modalCreate('planningSupervisorModal')">감리원 등록</button>
                <?php if ($monthCount > 0 && !empty($headerDate)) { ?>
                <button type="button" class="btn btn-sm btn-outline-secondary mb10" onclick="fontSet('up')">폰트 +</button>
                <button type="button" class="btn btn-sm btn-outline-secondary mb10" onclick="fontSet('down')">폰트 -</button>
                <button type="button" class="btn btn-sm btn-outline-secondary mb10" onclick="printPage()">인쇄하기</button>
                <?php } ?>
            </div>
        </div>
        <div class="table-responsive">
            <div class="print-area wd-fix">
